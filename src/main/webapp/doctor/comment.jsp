		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<div class="card-body">
						<p class="text-center fs-1 fw-bold">Patient Comment</p>
						...
						<form class="row" action="../updateStatus" method="post">
							...
							<div class="col-md-12">
								...
								<textarea required name="comm" class="form-control" row="5" cols="" style="height: 80px;font-size: 15px;"></textarea>
							</div>
							...
							<br/>
							<br/>
							<button class=" btn " style="font-size: xx-large;">Submit</button>
